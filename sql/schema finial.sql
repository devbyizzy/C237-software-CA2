...
-- =====================================================================
--  PERSON 2 — QUESTIONS & ANSWERS   [Nizamu — mine]
-- =====================================================================
CREATE TABLE questions (
    ...
    CONSTRAINT fk_questions_user FOREIGN KEY (user_id)
        REFERENCES users(user_id) ON DELETE CASCADE ON UPDATE CASCADE,
    FULLTEXT KEY ft_questions (title, content)   -- keyword search
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE question_replies (
    ...
    created_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_replies_question FOREIGN KEY (question_id)
...
CREATE TABLE helpful_votes (
    ...
    user_id    INT NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT uq_helpful UNIQUE (reply_id, user_id),
    CONSTRAINT fk_votes_reply FOREIGN KEY (reply_id)
        REFERENCES question_replies(reply_id) ON DELETE CASCADE ON UPDATE CASCADE,
